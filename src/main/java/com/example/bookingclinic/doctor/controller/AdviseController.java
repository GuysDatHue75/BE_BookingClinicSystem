...
public class AdviseController {
    ...
    @GetMapping("/pending")
    public ResponseEntity<List<Advisory>> getPending() {
        List<Advisory> list = adviseService.getListPending();
    ...
    public ResponseEntity<?> reply(
        ...
        try {
            ...
            Advisory result = adviseService.replyAdvise(maTuVan, maBacSi, noiDung);
