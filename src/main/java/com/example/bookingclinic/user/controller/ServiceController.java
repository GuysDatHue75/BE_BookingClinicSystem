...
public class ServiceController {
    ...
    public List<Doctor> searchDoctors(@RequestParam String name, @RequestParam String tp){
        ...
        return doctorReponsitory.findByTaiKhoan_HoVaTenContainingIgnoreCaseAndTaiKhoan_VaiTroAndPhongKham_TinhThanhPhoContainingIgnoreCase(name,"BacSi",tp);
    }
    ...
    public List<Doctor> getAllDoctorInCity(@PathVariable String tp){
       return doctorService.getAllDoctorInCity(tp);
    }
    ...
    public List<UClinic> getAllClinicsInCity(@PathVariable String tp){
       return clinicService.getAllClinicInCity(tp);
    }
