...
//     public RouterService(AIIntentService aiIntentService, DoctorService doctorService, ClinicService clinicService,AIService aiService){
...
// File: com.example.bookingclinic.user.service.RouterService.java
@Service
public class RouterService {
    private AIIntentService aiIntentService;
